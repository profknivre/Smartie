...
class MeasurementsInternals2():
    ...
    def __init__(self):
        ...
        bmp = Bmp280()
        self.bathroom_temperature = UberAdapter(bmp, 1, gauge_caption='mieszkanie.lazienka.temp')
        self.bathroom_humidity = UberAdapter(bmp, 0, gauge_caption='mieszkanie.lazienka.humidity')
